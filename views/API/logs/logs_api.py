...
def logs():
    ...
    logs = {log['_id']: log for log in db.log.find({'log_type':'Linux Command Assistant'}).sort('time', -1).skip(skip).limit(items_per_page)}    
    print(logs)
    filtered_logs = {}
...
# This Route: /API/logs
@logs_api_blueprint.route('/get-3', methods=['POST'])
@check_verification(['user','admin'])
def logs_3():
